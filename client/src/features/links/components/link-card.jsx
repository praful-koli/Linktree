...
const LinkCard = ({ link, onDelete, onEdit, onToggle }) => {
  return (
    <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className={`text-xs px-3 py-1 rounded-full ${link.isActive ? "bg-green-500/10 text-green-400" : "bg-zinc-800 text-zinc-400"}`}
        >
